...
def main(IndOptCluster, DirName, opt_cluster, CaseName_Base):
    ...
    # Now you can safely assign a value
    diff_df_1.loc[:, 'NetDemand'] = diff_df_1['Demand'] - diff_df_1['Wind'] - diff_df_1['Solar'] - diff_df_1['Hydro']

    diff_df_2 = diff_df_1['NetDemand']
    ...
    if IndClassify == 1:
        ...
        # Classify the values
        labels[pos_values[pos_values > diff_df_1.max()['NetDemand']].index] = 'Positive'
        labels[neg_values[neg_values < diff_df_1.min()['NetDemand']].index] = 'Negative'
