...
def main():
    ...
    print(f"Solving 1 {j}th of candidates, part {i}")
    nb_cand = len(clines)
    start_cand = int((i-1)* nb_cand / j)
    end_cand = int((i) * nb_cand / j)
    print(start_cand,end_cand)
    for (ni,nf,cc) in clines[start_cand:end_cand]:
