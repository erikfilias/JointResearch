...
#SBATCH --job-name="IEEE_mod2_FYOP_loop_All_nc160-200"
#SBATCH --nodes="1"
...
for origin_folder in "${origin_folders[@]}"; do
    ...
    python loop_operational_in_mem.py --case IEEE118_mod2 --origin_folder "$origin_folder" --min_nb 160 --max_nb 200
done
