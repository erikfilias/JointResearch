...
if __name__ == '__main__':
    ...
    exec_name = f"All_Exec_split_by_exec_penalize_test_bs_t{te_s}_v{val_s}"
    folder_to_save = f"RTS24_AC_12w_split_by_exec_test_{executions_start}_{executions_end}"
